package com.suimi.gracefulshutdown.endpoint;
...
import com.suimi.gracefulshutdown.service.Shutdown;
...
@Slf4j
public class GracefulShutdownEndpoint extends AbstractEndpoint<Map<String, Object>> implements
            ...
            final Thread thread = new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    try {
                        ...
                        log.info("We are now in OUT_OF_SERVICE mode, please wait " + wait + " second(s)...");
                        Thread.sleep(wait * 1000);
                        shutdown.pause();

                        // Pause the protocol.
                        log.info(
                                "Graceful shutdown in progess... We don't accept new connection... Wait after latest connections (max : " + timeout + " seconds)... ");
